...
for i = 2*T+1 :-1:1
    ...
    if i == 2*T+1
        for j=1:nnz(list)
            ...
            SecondPass.Nodes.Decision_Value(list(j)) =  E_smart(bwarea(SecondPass.Nodes.Agent_Region{list(j)}), SecondPass.Nodes.Agent_Detection_time(list(j)), SecondPass.Nodes.Teammate_Detection_time(list(j)), Negtive_Reward, Negtive_Teammate, Pr);
